...
class adaptation():
    ...
    def adapt(self,fichier, nbrEntree):
            ...
            while line:
                ...
                if int(words[0]) > nbrEntree:
                    ...
                    with open(words[1]) as f2:
                        ...
                        contient(string) de chaque trame de donnees et le second est un tableau de numbArray
    ...
    def execute(self):
        ...
        self.adapt(test, nbrEntree)
        self.adapt(train, nbrEntree)
        self.adapt(validation, nbrEntree)
